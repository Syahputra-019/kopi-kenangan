...
@section('content')
    <section>
        <div class="relative">
            <!-- Gambar -->
            <img src="{{ asset('/images/VIP.webp') }}" alt="" class="w-full h-auto">

            <!-- Tombol di atas gambar -->
            <div class="absolute bottom-5 left-1/2 transform -translate-x-1/2 z-10">
                <form action="" method="get">
                    <button type="submit"
                        class="w-64 h-16 mb-16 text-2xl font-bold text-white bg-amber-500 shadow-lg shadow-amber-700 rounded-full">
                        JOIN NOW
                    </button>
                </form>
            </div>
    ...
    <section class="flex bg-[#e7be96e9]">
        <div class="w-1/2 text-3xl font-bold pl-64 pr-64 pt-24 pb-24">
            <p>Tentang Loyalty Kenangan VIP</p>
        </div>
        <div class="w-1/2 text-xl pr-64 pt-24 pb-24">
            <p>
    ...
    <section class="p-24">
        <h1 class="text-3xl font-bold text-center p-8">Apa yang akan Kamu Dapatkan?</h1>
        ...
        <p class="text-xl text-center pb-0">
            Adapun keuntungan-keuntungan tersebut dapat dilihat seperti berikut:
        </p>
        <div class="p-16">
            <div class="flex justify-center gap-14 mb-14">
                <img src="{{ asset('images/ragular.webp') }}" alt="Regular" class="w-72 h-88 object-contain">
                <img src="{{ asset('images/hbd.webp') }}" alt="HBD" class="w-72 h-88 object-contain">
                <img src="{{ asset('images/spesial.png') }}" alt="Spesial" class="w-72 h-88 object-contain">
            </div>
            <div class="flex justify-center gap-20 ">
                <img src="{{ asset('images/exlusive.png') }}" alt="Exclusive" class="w-72 h-88 object-contain">
                <img src="{{ asset('images/black-reward.png') }}" alt="Reward" class="w-72 h-88 object-contain">
            </div>
        </div>

        <div class="flex justify-center text-base text-center pb-8">
    ...
    <section class="bg-black min-h-screen">
        <div class="">
            <div class="">
                <h1 class="text-3xl font-bold text-white text-center p-20">Hanya Butuh Beberapa Langkah untuk Bergabung:
                </h1>
                <div class="flex justify-center gap-16 pb-10">
                    <form action="/about" method="get">
                        <button type="submit"
                            class="w-56 h-16 font-bold text-2xl rounded-full bg-white text-black border-4 border-[#eea76d]">
                            Via Online
                        </button>
                    </form>
                    <form action="/about" method="get">
            ...
            <!-- Gambar -->
            <div class="flex justify-center gap-5 mt-16">
                <img src="{{ asset('images/download-1.png') }}" alt="1" class="w-[350px] h-[500px] object-contain">
                <img src="{{ asset('images/isi-2.png') }}" alt="2" class="w-[350px] h-[500px] object-contain">
                <img src="{{ asset('images/mulai-3.png') }}" alt="3" class="w-[350px] h-[500px] object-contain">
            </div>
        </div>

        <div class="text-center text-xl text-white p-24">
    ...
    <section class="bg-[#e7be96e9]">
        <div>
            <h1 class="text-3xl text-center font-bold max-w-4xl mx-auto mr-96 ml-96 pt-24 pb-8">Semakin Tinggi Levelmu,
                Semakin Banyak Keuntunganmu
            </h1>
        </div>
        <div class="flex justify-center">
            <img src="{{ asset('images/tabelvip.webp') }}" alt="Tabel" class="max-w-[900px] h-auto object-contain">
        </div>

        <div class="text-xl text-center max-w-4xl mx-auto">
            <p class="p-8">
        ...
        <div class="text-xl text-center mr-96 ml-96 pb-24">
            <p class="pb-8">
                Adapun syarat tersebut dapat dilihat seperti dibawah ini:
            </p>
            <img src="{{ asset('images/VIP-Level.webp') }}" alt="Level Vip" class="max-w-[1000] h-auto object-contain ">
        </div>
    </section>

    <section class="flex justify-center">
        <div class="w-1/3 text-3xl font-bold p-24 text-center">
            <h1>FAQ</h1>
        </div>
        <div class="w-1/2 pt-24 pr-24">
            {{-- FAQ 1 --}}
            <div class="pb-14">
    ...
    <section class="flex justify-center pt-40 pb-14">
        <a href="">
